...
<body>
	...
	<div class="host-sewa-box">
		...
		<div class="input-group mb-3">
			...
			<input type="number" value="<?= $homestay['harga'];?>" min="50000" max="2000000" step="50000" name="harga" id="harga" class="form-control"
		...
		<div class="form-group">
			...
			<select class="form-control" name="kapasitas" id="kapasitas" required>
				<option value="<?= $homestay['kapasitas'];?>" disabled>Pilih..</option>
		...
		<div class="form-group">
			...
			<input type="number" value="<?= $homestay['kamar_tidur'];?>" min="1" max="50" step="1" class="form-control" name="jml_kamar" id="jml_kamar"
				placeholder="Kamar Tidur" required>
		</div>
		<div class="form-group">
			<label for="jml_kamarmandi">Jumlah Kamar Mandi <span style="color: red;">*</span></label></label>
			<input type="number" value="<?= $homestay['kamar_mandi'];?>" min="1" max="50" step="1" class="form-control" name="jml_kamarmandi"
		...
		<div class="form-group">
			...
			<textarea class="form-control" name="deskripsi" id="deskripsi" minlength="100" maxlength="1000" rows="5"
				placeholder="Tulis Deskripsi" required><?= $homestay['deskripsi'];?></textarea>
		</div>
		<div class="input-group mb-3">
			<div class="input-group-prepend">
			...
			<input type="tel" value="<?= $homestay['no_wa'];?>" class="form-control" name="no_wa" placeholder="Nomor WA" id="no_wa" required>
		</div>
